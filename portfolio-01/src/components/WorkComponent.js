                ...
                <div className="container mt-3">
                    ...
                    <div className="col">
                        ...
                        <Modal size="xl" className="modal-fullscreen" isOpen={this.state.isMTModalOpen} toggle={this.toggleModalMT}>
                            ...
                            <ModalBody>
                                <p>I literally helped build Merchtable (formerly Blue Collar Distro) with my bare hands, starting with framing the darkroom in our first basement space. From my earliest build of the website using Dreamweaver and Fireworks in 2002, through transitions to MivaMerchant, followed by overseeing an OSCommerce rebuild with Varien, to our most current version which runs on Ruby on Rails which was built and launched in 2012, I have either built, designed, or product managed the entire platform (sometimes all three).</p>
