                ...
                <div className="container mt-3">
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            ...
                            <li>
                                <span className="feature">Growth</span> - Over the course of 18 years, helped grow the revenues of my company from $10,000 to over $7 million in 2020 during the height of the pandemic, with our fulfillment center averaging around 100,000 orders per year and just under 1,000,000 registered users.
                            </li>
                            <li>
